...
import { kpiChat, kpiService_m, kpiInv_m } from "@/app/data/analysis/skuProData";
...
export function Backorder({ props: { symbol, price, delta } }: { props: Stock }) {
  ...
  return (
    <div className="rounded-xl border  p-4 text-gray-800 dark:text-white">
